void contactStarted(FContact contacto) {
  ...
  if (nombre1 == "cursor" && nombre2 == "play" && estado == 0 && contador > 100) {
    estado = 1;
  }
  if (nombre2 == "cursor" && nombre1 == "play" && estado == 0 && contador > 100) {
    estado = 1;
  }
  // perder
  if (nombre1 == "cursor" && nombre2 == "inicioP" && estado == 3 && contador > 100) {
    estado = 0;
  }
  if (nombre2 == "cursor" && nombre1 == "inicioP" && estado == 3 && contador > 100) {
    estado = 0;
  }
  // ganar
  if (nombre1 == "cursor" && nombre2 == "inicioG" && estado == 2 && contador > 100) {
    estado = 0;
  }
  if (nombre2 == "cursor" && nombre1 == "inicioG" && estado == 2 && contador > 100) {
    estado = 0;
  }
  //.............................................................. reiniciar pantallas
